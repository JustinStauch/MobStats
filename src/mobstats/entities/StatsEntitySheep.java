 ...
 */
public class StatsEntitySheep extends EntitySheep implements StatsEntity {
    private int level;
    private int maxHealth;
    
    public StatsEntitySheep(World world) {
        super(world);
    ...
    public StatsEntitySheep(World world, int level, int maxHealth) {
        super(world);
        this.level = level;

 ...
 */
public class StatsEntitySpider extends EntitySpider implements StatsEntity {
    private int level;
    private int maxHealth;
    
    public StatsEntitySpider(World world) {
        super(world);
    ...
    public StatsEntitySpider(World world, int level, int maxHealth) {
        super(world);
        this.level = level;

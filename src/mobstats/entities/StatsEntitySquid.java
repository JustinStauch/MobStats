 ...
 */
public class StatsEntitySquid extends EntitySquid implements StatsEntity {
    private int level;
    private int maxHealth;
    
    public StatsEntitySquid(World world) {
        super(world);
    ...
    public StatsEntitySquid(World world, int level, int maxHealth) {
        super(world);
        this.level = level;

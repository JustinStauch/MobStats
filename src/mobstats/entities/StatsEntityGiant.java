 ...
 */
public class StatsEntityGiant extends EntityGiantZombie implements StatsEntity {
    private int level;
    private int maxHealth;
    
    public StatsEntityGiant(World world) {
        super(world);
    ...
    public StatsEntityGiant(World world, int level, int maxHealth) {
        super(world);
        this.level = level;

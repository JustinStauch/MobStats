 ...
 */
public class StatsEntityBat extends EntityBat implements StatsEntity {
    private int level;
    private int maxHealth;
    
    public StatsEntityBat(World world) {
        super(world);
    ...
    public StatsEntityBat(World world, int level, int maxHealth) {
        super(world);
        this.level = level;

 ...
 */
public class StatsEntityCaveSpider extends EntityCaveSpider implements StatsEntity {
    private int level;
    private int maxHealth;
    
    public StatsEntityCaveSpider(World world) {
        super(world);
    ...
    public StatsEntityCaveSpider(World world, int level, int maxHealth) {
        super(world);
        this.level = level;

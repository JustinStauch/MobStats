 ...
 */
public class StatsEntityMushroomCow extends EntityMushroomCow implements StatsEntity {
    private int level;
    private int maxHealth;
    
    public StatsEntityMushroomCow(World world) {
        super(world);
    ...
    public StatsEntityMushroomCow(World world, int level, int maxHealth) {
        super(world);
        this.level = level;

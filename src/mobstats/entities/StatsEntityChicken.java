 ...
 */
public class StatsEntityChicken extends EntityChicken implements StatsEntity {
    private int level;
    private int maxHealth;
    
    public StatsEntityChicken(World world) {
        super(world);
    ...
    public StatsEntityChicken(World world, int level, int maxHealth) {
        super(world);
        this.level = level;

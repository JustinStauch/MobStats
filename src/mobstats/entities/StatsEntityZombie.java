 ...
 */
public class StatsEntityZombie extends EntityZombie implements StatsEntity {
    private int level;
    private int maxHealth;
    
    public StatsEntityZombie(World world) {
        super(world);
    ...
    public StatsEntityZombie(World world, int level, int maxHealth) {
        super(world);
        this.level = level;

 ...
 */
public class StatsEntityEnderDragon extends EntityEnderDragon implements StatsEntity {
    private int level;
    private int maxHealth;
    
    public StatsEntityEnderDragon(World world) {
        super(world);
    ...
    public StatsEntityEnderDragon(World world, int level, int maxHealth) {
        super(world);
        this.level = level;

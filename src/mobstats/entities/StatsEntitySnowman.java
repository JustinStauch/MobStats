 ...
 */
public class StatsEntitySnowman extends EntitySnowman implements StatsEntity {
    private int level;
    private int maxHealth;
    
    public StatsEntitySnowman(World world) {
        super(world);
    ...
    public StatsEntitySnowman(World world, int level, int maxHealth) {
        super(world);
        this.level = level;

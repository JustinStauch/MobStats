 ...
 */
public class StatsEntityCow extends EntityCow implements StatsEntity {
    private int level;
    private int maxHealth;
    
    public StatsEntityCow(World world) {
        super(world);
    ...
    public StatsEntityCow(World world, int level, int maxHealth) {
        super(world);
        this.level = level;

 ...
 */
public class StatsEntityPigZombie extends EntityPigZombie implements StatsEntity {
    private int level;
    private int maxHealth;
    
    public StatsEntityPigZombie(World world) {
        super(world);
    ...
    public StatsEntityPigZombie(World world, int level, int maxHealth) {
        super(world);
        this.level = level;

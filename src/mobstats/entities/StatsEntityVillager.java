 ...
 */
public class StatsEntityVillager extends EntityVillager implements StatsEntity {
    private int level;
    private int maxHealth;
    
    public StatsEntityVillager(World world) {
        super(world);
    ...
    public StatsEntityVillager(World world, int level, int maxHealth) {
        super(world);
        this.level = level;

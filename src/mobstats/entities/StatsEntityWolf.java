 ...
 */
public class StatsEntityWolf extends EntityWolf implements StatsEntity {
    private int level;
    private int maxHealth;
    
    public StatsEntityWolf(World world) {
        super(world);
    ...
    public StatsEntityWolf(World world, int level, int maxHealth) {
        super(world);
        this.level = level;
